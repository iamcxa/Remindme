 ...
 */
public class CopyOfListCursorCardFragment extends BaseFragment implements
	...
	public class MyCursorCardAdapter extends CardCursorAdapter {
		...
		private void setCardFromCursor(MyCursorCard card, Cursor cursor) {
			...
			// 時間日期 - sec line
			card.DateTime = "再 " + " 天 - " + cursor.getString(CommonUtils.RemindmeTaskCursor.IndexColumns.EndDate);
